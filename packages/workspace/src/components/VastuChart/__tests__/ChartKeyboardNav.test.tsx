...
describe('VastuChart — view as table toggle', () => {
  it('shows the "View as table" button for non-sparkline chart types', () => {
    ...
    for (const type of chartTypes) {
      ...
      expect(screen.getByRole('button', { name: 'View as table' })).toBeTruthy();
      unmount();
    }
  });
  ...
  it('shows "View as chart" button when in table view', () => {
    ...
    const toggleBtn = screen.getByRole('button', { name: 'View as table' });
    fireEvent.click(toggleBtn);
    expect(screen.getByRole('button', { name: 'View as chart' })).toBeTruthy();
  });
  ...
  it('toggles back to chart view from table view', () => {
    ...
    const toggleBtn = screen.getByRole('button', { name: 'View as table' });
    fireEvent.click(toggleBtn);
    const chartBtn = screen.getByRole('button', { name: 'View as chart' });
